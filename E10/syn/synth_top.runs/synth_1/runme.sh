...
HD_PWD='D:/Logic_Synthesis/5/E10/syn/synth_top.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_top_level_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_top_level_wrapper.tcl
