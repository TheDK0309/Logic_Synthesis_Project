...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net i2c_config_0_param_status_out [get_bd_pins i2c_config_0/param_status_out] [get_bd_pins util_vector_logic_1/Op1]
  ...
  connect_bd_net -net pin_keys_1 [get_bd_ports pin_keys] [get_bd_pins synthesizer_0/keys_in] [get_bd_pins util_vector_logic_1/Op2]
  connect_bd_net -net pin_rst_n_1 [get_bd_ports pin_rst_n] [get_bd_pins util_vector_logic_0/Op2]
  ...
  connect_bd_net -net util_vector_logic_1_Res [get_bd_ports pin_leds_i2c] [get_bd_pins util_vector_logic_1/Res]
